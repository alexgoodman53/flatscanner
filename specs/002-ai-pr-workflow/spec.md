...
- Replace the placeholder AI review workflow with a real Codex review action
- Document the required GitHub branch protection settings
...
- The AI review workflow must post review output back to the pull request
...
- A PR-triggered GitHub Actions workflow runs Codex review using repository context
